...
The left term is our prediction of the gradient term in the reverse diffusion process. The right term is a sort of ground-truth of the gradient term, this is derived explicitly from the paper, and can be done so by explicitly solving the forward diffusion differential equation.
...
TODO: DDSP, maybe expend on diffusion more, add a demo, use more pictures
